...
/*   Updated: 2022/10/21 12:35:33 by imoore           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//--adding the new node to the sacrifice(if int true == 1 - the head pointer)
// or bottom of the list--//
//notes: something will need to be freed but ideally when the list is cleared 
//(end of program) or when a node is deleted
...
//--deletes a node from the top of the list (and sets the nxtnode to
//be head pointer)--//
